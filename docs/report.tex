...
% ── Real image command ────────────────────────────────────────────────────────
% Replace \imgplaceholder with \img once you have the screenshots:
% \newcommand{\img}[4]{\begin{figure}[H]\centering\includegraphics[width=#1]{screenshots/#3}\caption{#4}\label{fig:#3}\end{figure}}
...
% ── IMAGE 1: DVC DAG ──────────────────────────────────────────────────────────
\imgplaceholder{0.6\textwidth}{5cm}{dvc-dag}%
  {DVC pipeline DAG --- run \texttt{dvc dag} in the project root to reproduce}
...
% ── IMAGE 2: MLflow runs list ─────────────────────────────────────────────────
\imgplaceholder{\textwidth}{6cm}{mlflow-runs}%
  {MLflow experiment view showing all training runs with loss metrics}

% ── IMAGE 3: MLflow loss curve ────────────────────────────────────────────────
\imgplaceholder{\textwidth}{6cm}{mlflow-loss-curve}%
  {Training loss curve from the final whisper-tiny run (loss: 5.12 $\rightarrow$ 0.86)}

% ── IMAGE 4: MLflow model registry ───────────────────────────────────────────
\imgplaceholder{0.8\textwidth}{5cm}{mlflow-registry}%
...
% ── IMAGE 5: Grafana dashboard ────────────────────────────────────────────────
\imgplaceholder{\textwidth}{6cm}{grafana-dashboard}%
  {Grafana dashboard showing inference latency, OOV rate, and request volume in near-real-time}

% ── IMAGE 6: Prometheus targets ───────────────────────────────────────────────
\imgplaceholder{0.8\textwidth}{4cm}{prometheus-targets}%
